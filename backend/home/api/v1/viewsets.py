...
from home.models import Alligator,Azul,Cat,Newmo,Wolf
from .serializers import AlligatorSerializer,AzulSerializer,CatSerializer,NewmoSerializer,WolfSerializer
...
class WolfViewSet(viewsets.ModelViewSet):
