...
function modules_articles_article_update(payload) {
  return juandevAPI.put(`/modules/articles/article/${payload.id}/`, payload.data);
}

function modules_articles_article_partial_update(payload) {
  return juandevAPI.patch(`/modules/articles/article/${payload.id}/`, payload.data);
}
...
function modules_two_factor_authentication_verify_destroy(payload) {
  return juandevAPI.delete(`/modules/two-factor-authentication/verify/${payload.id}/`);
}
...
function modules_two_factor_authentication_twofactorauth_create(payload) {
  return juandevAPI.post(`/modules/two-factor-authentication/twofactorauth/`, payload.data);
}

function modules_two_factor_authentication_twofactorauth_retrieve(payload) {
  return juandevAPI.get(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`);
}

function modules_two_factor_authentication_twofactorauth_update(payload) {
  return juandevAPI.put(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`, payload.data);
}

function modules_two_factor_authentication_twofactorauth_partial_update(payload) {
  return juandevAPI.patch(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`, payload.data);
}

function modules_two_factor_authentication_twofactorauth_destroy(payload) {
  return juandevAPI.delete(`/modules/two-factor-authentication/twofactorauth/${payload.id}/`);
}

function modules_two_factor_authentication_twofactorauth_send_otp_create(payload) {
  return juandevAPI.post(`/modules/two-factor-authentication/twofactorauth/send_otp/`, payload.data);
}
