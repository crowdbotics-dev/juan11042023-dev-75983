...
export const api_v1_wolf_list = createAsyncThunk(
  "wolves/api_v1_wolf_list",
  async payload => {
    const response = await apiService.api_v1_wolf_list(payload)
    return response.data
  }
)
export const api_v1_wolf_create = createAsyncThunk(
  "wolves/api_v1_wolf_create",
  async payload => {
    const response = await apiService.api_v1_wolf_create(payload)
    return response.data
  }
)
export const api_v1_wolf_retrieve = createAsyncThunk(
  "wolves/api_v1_wolf_retrieve",
  async payload => {
    const response = await apiService.api_v1_wolf_retrieve(payload)
    return response.data
  }
)
export const api_v1_wolf_update = createAsyncThunk(
  "wolves/api_v1_wolf_update",
  async payload => {
    const response = await apiService.api_v1_wolf_update(payload)
    return response.data
  }
)
export const api_v1_wolf_partial_update = createAsyncThunk(
  "wolves/api_v1_wolf_partial_update",
  async payload => {
    const response = await apiService.api_v1_wolf_partial_update(payload)
    return response.data
  }
)
export const api_v1_wolf_destroy = createAsyncThunk(
  "wolves/api_v1_wolf_destroy",
  async payload => {
