...
export const api_v1_alligator_list = createAsyncThunk("alligators/api_v1_alligator_list", async payload => {
  const response = await apiService.api_v1_alligator_list(payload);
  return response.data;
});
export const api_v1_alligator_create = createAsyncThunk("alligators/api_v1_alligator_create", async payload => {
  const response = await apiService.api_v1_alligator_create(payload);
  return response.data;
});
export const api_v1_alligator_retrieve = createAsyncThunk("alligators/api_v1_alligator_retrieve", async payload => {
  const response = await apiService.api_v1_alligator_retrieve(payload);
  return response.data;
});
export const api_v1_alligator_update = createAsyncThunk("alligators/api_v1_alligator_update", async payload => {
  const response = await apiService.api_v1_alligator_update(payload);
  return response.data;
});
export const api_v1_alligator_partial_update = createAsyncThunk("alligators/api_v1_alligator_partial_update", async payload => {
  const response = await apiService.api_v1_alligator_partial_update(payload);
  return response.data;
});
export const api_v1_alligator_destroy = createAsyncThunk("alligators/api_v1_alligator_destroy", async payload => {
